...
def run_hook(tmp_path: Path, env: dict[str, str], path_with: tuple[str, ...]) -> str:
    """Run the SessionStart hook with only the named binaries on PATH; returns what it printed."""
